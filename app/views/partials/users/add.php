            ...
            <div class="row ">
                ...
                <div class="col-md-7 comp-grid">
                    ...
                    <div  class=" animated fadeIn">
                        <form id="users-add-form" role="form" novalidate enctype="multipart/form-data" class="form form-horizontal needs-validation" action="<?php print_link("users/add?csrf_token=$csrf_token") ?>" method="post">
                            <div>
                                ...
                                <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <label class="control-label" for="user_pass">User Pass <span class="text-danger">*</span></label>
                                            </div>
                                            <div class="col-sm-8">
                                                <div class="">
                                                    <input id="ctrl-user_pass"  value="<?php  echo $this->set_field_value('user_pass',''); ?>" type="password" placeholder="Enter User Pass"  required="" name="user_pass"  class="form-control " />
                                        ...
                                        <div class="form-group ">
                                            <div class="row">
                                                <div class="col-sm-4">
                                                    <label class="control-label" for="user_dp">User Dp <span class="text-danger">*</span></label>
                                                </div>
                                                <div class="col-sm-8">
                                                    <div class="">
                                                        
                                                        <div class="dropzone required" id="user_dp_upload" input="#ctrl-user_dp" fieldname="user_dp"    data-multiple="false"    btntext="Browse" extensions=".jpg,.png,.gif,.jpeg" filesize="3" maximum="1">
                                                            <input name="user_dp" id="ctrl-user_dp" required="" class="dropzone-input form-control" value="<?php  echo $this->set_field_value('user_dp',''); ?>" type="text"  />
