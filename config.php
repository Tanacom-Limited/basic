<?php
	...
	define('SITE_NAME' , "Tanacom Systems");
	...
	define('APP_ID',"d893389c7d87fab853632a39b37f2bfa");
	...
	define('USER_PHOTO',(isset($_SESSION[APP_ID.'user_data']) ? $_SESSION[APP_ID.'user_data']['user_dp'] : null ));
