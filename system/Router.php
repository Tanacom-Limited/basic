...
class Router
{
	...
	function run($url)
	{
		...
		//Remove any unwanted characters as these are used to interact with the database
		$part1 = filter_var($part1, FILTER_SANITIZE_STRING);
		$part2 = filter_var($part2, FILTER_SANITIZE_STRING);
		$part3 = filter_var($part3, FILTER_SANITIZE_STRING);
		$part4 = filter_var($part4, FILTER_SANITIZE_STRING);
		...
		if (class_exists($controller_name, true)) {
			...
			if (method_exists($controller, $action)) {		//when url like  page/pageid
